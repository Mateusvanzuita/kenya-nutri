...
export default function Testimonials() {
  ...
  const testimonials = [
    ...
    },
    {
      name: 'Bruna C.',
      role: 'Definição',
      quote: 'O mais incrível é que eu comecei a comer mais do que quando "fazia dieta sozinha" e coisas surreais de tão boas, isso faz com que a gente siga a dieta tranquilamente, sem passar necessidade e/ou vontades.',
